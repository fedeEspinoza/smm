...
class UsuariosControllerTest < ActionController::TestCase
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post :create, usuario: { categorium_id: @usuario.categorium_id, circunscripcion: @usuario.circunscripcion, domicilio: @usuario.domicilio, estado_id: @usuario.estado_id, latitud: @usuario.latitud, longitud: @usuario.longitud, manzana: @usuario.manzana, numero: @usuario.numero, parcela: @usuario.parcela, razon_social: @usuario.razon_social, sector: @usuario.sector, tipo: @usuario.tipo, unidad_funcional: @usuario.unidad_funcional }
    end
