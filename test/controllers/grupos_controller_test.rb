...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { codigo: @grupo.codigo, descripcion: @grupo.descripcion, nombre: @grupo.nombre }
    end
  ...
  test "should update grupo" do
    patch :update, id: @grupo, grupo: { codigo: @grupo.codigo, descripcion: @grupo.descripcion, nombre: @grupo.nombre }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
