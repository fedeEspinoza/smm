class CategoriaController < ApplicationController
  before_action :authenticate_user!, :set_categorium, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to @categorium, notice: 'Se ha creado una nueva Categoria.' }
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to @categorium, notice: 'Se ha actualizado la Categoria.' }
  ...
  def destroy
    @categorium.destroy
    respond_to do |format|
      format.html { redirect_to categoria_url, notice: 'Se ha eliminado la Categoria.' }
  ...
  private
    ...
    def categorium_params
      params.require(:categorium).permit(:codigo, :descripcion)
    end
end
